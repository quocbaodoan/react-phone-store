...
export const storeProducts = [
  {
    id: 1,
    title: "Vsmart Aris Pro",
    img: "img/product-1.png",
    price: "9.990.000",
    company: "Vsmart",
    info:
      "Vsmart Aris Pro nổi bật bởi sở hữu camera tàng hình hay còn gọi là camera ẩn dưới màn hình và đương nhiên thiết bị là một trong những smartphone dẫn đầu trong cuộc đua công nghệ. Với sự hỗ trợ này, màn hình 6.39 inch ở mặt trước của sản phẩm trở nên hoàn hảo hơn. Đồng thời máy được trang bị vi xử lý Snapdragon 730G và 8 GB RAM giúp cho sản phẩm có thể đáp ứng tất cả ứng dụng có mặt trên CH Play. Kèm theo đó bộ nhớ trong lên đến 128 GB của máy cho khả năng lưu trữ lớn. Cuối cùng viên pin 4.000 mAh được trang bị kèm với sạc nhanh đủ đáp ứng cho bạn một ngày dài năng động và bạn sẽ không chờ quá lâu trong thời gian sạc để quay lại sử dụng thiết bị.",
    inCart: false,
    count: 0,
    total: 0
  },
  ...
  },
  {
    ...
    company: "Nokia",
    info:
      "Nokia 8.3 nổi bật với danh hiệu smartphone 5G đầu tiên của Nokia, bên cạnh đó là những cải tiến mạnh mẽ về hiệu năng và chất lượng camera.",
    inCart: false,
    count: 0,
    total: 0
  },
  {
    id: 4,
    title: "OnePlus 8 Pro 5G",
    img: "img/product-4.png",
    price: "22.990.000",
    company: "OnePlus",
    info:
      "OnePlus 8 Pro 5G là chiếc điện thoại đánh dấu bước ngoặt của OnePlus trong năm 2020, smartphone đã và đang khẳng định lại vị trí của mình trên thị trường flagship cao cấp với kế độc đáo, cụm camera ấn tượng, hiệu năng siêu khủng tích hợp nhiều công nghệ hiện đại.",
    inCart: false,
    count: 0,
    total: 0
  },
  {
    ...
    company: "Huawei",
    info:
      "Huawei P40 Pro là một trong 3 mẫu smartphone đầu bảng năm 2020 đến từ nhà Huawei. Chiếc máy sở hữu cụm 4 camera Leica chụp ảnh và quay phim đỉnh cao, thiết kế màn hình siêu tràn ấn tượng cùng hiệu năng khủng xứng tầm flagship.",
    inCart: false,
    count: 0,
    total: 0
  },
  {
    ...
    company: "Xiaomi",
    info:
      "Mi 10T Pro 5G mẫu smartphone cao cấp của Xiaomi trong năm 2020 cuối cùng cũng được trình làng với loạt những thông số gây “choáng ngợp”: màn hình tần số quét 144 Hz, vi xử lý Snapdragon 865 và cụm camera khủng 108 MP kèm theo đó là một mức giá dễ chịu cho người dùng.",
    inCart: false,
    count: 0,
    total: 0
  },
